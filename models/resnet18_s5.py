...
num_unfrozen_center_layers = 3   #exp with 1 or 2(max)
...
class back(nn.Module):
    def __init__(self, pretrained=False, output_dim=10):
        ...
        fc_layer2 = nn.Linear(64, output_dim)
        fc_layer1 = nn.Linear(512, 64)
        model_children = model_children[:-1] + [nn.Flatten()] + [fc_layer1] + [fc_layer2]
        ...
        print("up_num_back_layers",up_num_back_layers)
        if pretrained:
